...
namespace ExportLibrary
{
    public static class IEnumerableExtensions
    {
        ...
        /// </summary>
        public static Exporter<T> GetExporter<T>(
            this IEnumerable<T> source, String seperator = ";") where T : class
        {
            return new Exporter<T>(source, seperator);
        }
    }
    ...
    public class Exporter<T> where T : class
    {
        ...
        public Exporter(IEnumerable<T> sourceList, String seperator = ";")
        {
        ...
        public Exporter<T> AddExportableColumn(
